...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Babylonian Clay Tablets at VSU</title>
...
<div class="wrapper">
    ...
    <img src="img/baby-header.jpg" width="100%" height="auto">
     </div>
	<div class="nav">
    	<?php include("includes/menu.html"); ?>
    </div>
    <div class="content">
    <h1>Valdosta One - Umma, Amar-Suen. Year 1.</h1>
    <h4><a href="#">Dr. Cale Johnson's Translation of Tablet One</a></h4>
    <div class="AJXIRVCacETB">
      <!-- AJXFILE:css/ajximagerotator.css -->
      <div class="AJXIRVCacETBpics">
        <ul class="AJXIRVCacETBul">
          <li class="AJXIRVCacETBli"><a href="#"><img class="AJXIRVCacETBimg" src="img/tablets/tablet1_front.jpg" alt=""></a></li>
          <li class="AJXIRVCacETBlihide"><a href="#"><img class="AJXIRVCacETBimg" src="img/tablets/tablet1_back.jpg" alt=""></a></li>
          <li class="AJXIRVCacETBlihide"><a href="#"><img class="AJXIRVCacETBimg" src="img/tablets/tablet1_top-bottom.jpg" alt=""></a></li>
          <li class="AJXIRVCacETBlihide"><a href="#"><img class="AJXIRVCacETBimg" src="img/tablets/tablet1_left-right.jpg" alt=""></a></li>
        </ul>
      </div>
    </div>
...
<div class="CSSTableGenerator">
  ...
  <tr>
    <td>1. 1/3(diš) ma-na ša3-gu sig?;</td>
    <td>1/3 mina of ... šagu</td>
  </tr>
  <tr>
    <td>2. ki a-DU-ta</td>
    <td>from ADU</td>
  ...
  <tr>
    <td>3. la-ni-mu šu ba-ti</td>
    <td>Lanimu received.</td>
  </tr>
  <tr>
    <td>(1 line blank)</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>1. mu damar-dsuen lugal</td>
    <td>Year: “Amar-Suen (is) king” (Amar-Suen, year 1)
</td>
  </tr>
</table> 
</div>
